...
import css from './ModalWayOrderMobile.module.scss'
  ...
  return (
    ...
    >
      <div className={css.container}>
        ...
        <Padding value={20} />
        <ul>
          <li>Просто позвонить по номеру <b>{MAIN_PHONE_LINK}</b> (В сыктывкаре),<br /> или {MAIN_PHONE_LONG_LINK} (по республике Коми и России)</li>
